...
import { supabase, UnidadMedida } from '../lib/supabase';
...
export function UnidadesMedida() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('Error al guardar unidad de medida');
      console.error(err);
    }
  };
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      setError('Error al eliminar unidad de medida');
      console.error(err);
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-gray-800">Unidades de Medida</h1>
        <button
          onClick={() => {
            resetForm();
            setShowModal(true);
